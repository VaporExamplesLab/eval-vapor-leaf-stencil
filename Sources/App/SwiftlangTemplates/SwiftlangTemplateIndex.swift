...
struct SwiftlangTemplateIndex: SwiftlangTemplate {
    ...
    <ul>
    <li><a href="http://localhost:8080/leaf/latexmath">/leaf/latexmath</a>, <a href="http://localhost:8080/leaf/latexmath_inline">inline</a>, <a href="http://localhost:8080/leaf/latexmath_single">single</a></li>
    <li><a href="http://localhost:8080/stencil/latexmath">/stencil/latexmath</a>, <a href="http://localhost:8080/stencil/latexmath_inline">inline</a>, <a href="http://localhost:8080/stencil/latexmath_single">single</a><br />
    </li>
    ...
    <ul>
    <li><a href="http://localhost:8080/leaf/codeblog">/leaf/codeblog</a>, <a href="http://localhost:8080/leaf/codeblog_inline">inline</a>, <a href="http://localhost:8080/leaf/codeblog_single">single</a></li>
    <li><a href="http://localhost:8080/stencil/codeblog">/stencil/codeblog</a>, <a href="http://localhost:8080/stencil/codeblog_inline">inline</a>, <a href="http://localhost:8080/stencil/codeblog_single">single</a></li>
    ...
    <ul>
    <li><a href="http://localhost:8080/leaf/mdtohtml">/leaf/mdtohtml</a>, <a href="http://localhost:8080/leaf/mdtohtml_inline">inline</a>, <a href="http://localhost:8080/leaf/mdtohtml_single">single</a></li>
    <li><a href="http://localhost:8080/stencil/mdtohtml">/stencil/mdtohtml</a>, <a href="http://localhost:8080/stencil/mdtohtml_inline">inline</a>, <a href="http://localhost:8080/stencil/mdtohtml_single">single</a></li>
