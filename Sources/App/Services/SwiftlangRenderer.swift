...
public final class SwiftlangRenderer: ViewRenderer, Service {
    ...
    public func render<E>(
        ...
        -> Future<View> where E : Encodable {
            var template: SwiftlangTemplate
            switch path {
            case "hello":
                template = SwiftlangTemplateHello()
            default:
                template = SwiftlangTemplate404()
            }
